<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationStudent.aspx.cs" Inherits="WebApplication22.RegistrationStudent" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="biggercontainer">
        <div class="right-section">
            <h1>Start for free! <span style="color: #007bff;">faster</span></h1>
            <p style="text-align: center;">Post Your Education for Free & get Attractive Offers!</p>
            <div class="imgbg">
                <img src="gg.png" alt="Example Image"/>
                 <img src="hh.png" alt="Example Image"/>
                 <img src="ww.png" alt="Example Image" class="imgbg1"/>
                <img src="hm.png" alt="Example Image" class="imgbg1"/>
            </div>
        </div>
            ...
            <div class="container">
                <form id="registrationForm" runat="server">
                    ...
                    <div class="text-center">
                        <asp:Button ID="submitButton" runat="server" CssClass="btn-primary" Text="Register for Free" OnClick="SubmitButton_Click" />
